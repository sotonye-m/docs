...
See the full field reference at [/yativo-fiat/kyc](/yativo-fiat/kyc), including optional fields such as `account_purpose_other`, `uploaded_documents`, and `sumsub_token`.
