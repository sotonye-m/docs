...
<RequestExample>
```bash cURL
curl -X GET 'https://api.yativo.com/api/v1/business/profile' \
...
<RequestExample>
```bash cURL
curl -X GET 'https://api.yativo.com/api/v1/business/balances' \
  -H 'Authorization: Bearer YOUR_ACCESS_TOKEN'
```
</RequestExample>
...
<RequestExample>
```bash cURL
curl -X GET 'https://api.yativo.com/api/v1/business/fees' \
  -H 'Authorization: Bearer YOUR_ACCESS_TOKEN'
```
</RequestExample>
...
<RequestExample>
```bash cURL
curl -X GET 'https://api.yativo.com/api/v1/business/currencies' \
  -H 'Authorization: Bearer YOUR_ACCESS_TOKEN'
```
</RequestExample>
