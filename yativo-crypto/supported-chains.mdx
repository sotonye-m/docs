...
| Optimism             | Mainnet  | `OP` (156)           | OP              |
| Arbitrum             | Mainnet  | `ARB` (84)           | ARB             |
| Tron                 | Mainnet  | `TRON` (8)           | TRX             |
| Avalanche            | Mainnet  | `AVAX` (28)          | AVAX            |
...
|--------|-------|------|
| TRX    | Tron | Native |
| USDC_TRON | USD Coin (Tron) | TRC20 |
| USDT_TRON | Tether (Tron) | TRC20 |
