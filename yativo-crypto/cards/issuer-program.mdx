...
Subscribe to issuer events via `POST /v1/yativo-card/webhooks`. See [Webhook Events](/api-reference/issuer/webhooks) for the full event reference, payload examples, and signature verification.
