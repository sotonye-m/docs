...
type WebhookEventType =
  ...
  | "gas.low"
  // Card lifecycle (card webhook system)
  | "card.created"
  | "card.activated"
  | "card.frozen"
  | "card.unfrozen"
...
interface CreateWebhookRequest {
  // General webhook (POST /webhooks/create)
  webhook_name: string;        // required
  webhook_url: string;         // required
  webhook_secret: string;      // required - you supply this
  whitelist_ips?: string[];

  // Card webhook (POST /yativo-card/webhooks)
