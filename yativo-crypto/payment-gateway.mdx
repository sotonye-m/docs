...
```bash
curl -X POST 'https://crypto-api.yativo.com/api/crypto-gateway/payments' \
...
```bash
curl -X GET 'https://crypto-api.yativo.com/api/crypto-gateway/pay/pi_01abc123/status'
```
...
```bash
curl -X GET 'https://crypto-api.yativo.com/api/crypto-gateway/payments' \
  -H 'Authorization: Bearer YOUR_ACCESS_TOKEN'
```
...
```bash
curl -X GET 'https://crypto-api.yativo.com/api/crypto-gateway/overview' \
  -H 'Authorization: Bearer YOUR_ACCESS_TOKEN'
```
