...
```bash
curl -X GET 'https://crypto-api.yativo.com/api/unified-transactions/list?page=1&limit=20' \
...
```bash
curl -X GET 'https://crypto-api.yativo.com/api/unified-transactions/utx_01abc123' \
  -H 'Authorization: Bearer YOUR_ACCESS_TOKEN'
```
...
```bash
curl -X POST 'https://crypto-api.yativo.com/api/unified-transactions/calculate-fees' \
  -H 'Authorization: Bearer YOUR_ACCESS_TOKEN' \
...
```bash
curl -X GET 'https://crypto-api.yativo.com/api/unified-transactions/analytics-with-fees' \
  -H 'Authorization: Bearer YOUR_ACCESS_TOKEN'
```
...
```bash
curl -X POST 'https://crypto-api.yativo.com/api/unified-transactions/export' \
  -H 'Authorization: Bearer YOUR_ACCESS_TOKEN' \
  -H 'Content-Type: application/json' \
  -d '{
    "format": "pdf",
...
```bash
curl -X GET 'https://crypto-api.yativo.com/api/unified-transactions/export/list' \
  -H 'Authorization: Bearer YOUR_ACCESS_TOKEN'
```
...
```bash
curl -X GET 'https://crypto-api.yativo.com/api/unified-transactions/export/exp_01abc123/download' \
  -H 'Authorization: Bearer YOUR_ACCESS_TOKEN' \
