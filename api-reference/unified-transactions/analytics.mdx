...
api: "GET https://crypto-sandbox.yativo.com/api/unified-transactions/analytics-with-fees"
...
<RequestExample>
```bash
curl -X GET 'https://crypto-sandbox.yativo.com/api/unified-transactions/analytics-with-fees' \
