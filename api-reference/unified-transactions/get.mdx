...
api: "GET https://crypto-sandbox.yativo.com/api/unified-transactions/{transaction_id}"
...
<RequestExample>
```bash
curl -X GET 'https://crypto-sandbox.yativo.com/api/unified-transactions/utx_01abc123' \
