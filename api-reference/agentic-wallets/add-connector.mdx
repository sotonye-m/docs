---
title: "Add Connector"
api: "POST https://crypto-sandbox.yativo.com/api/v1/agentic-wallets/{walletId}/connectors"
...
<RequestExample>
```bash
curl -X POST 'https://crypto-sandbox.yativo.com/api/v1/agentic-wallets/aw_01abc123/connectors' \
