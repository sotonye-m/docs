...
api: "POST https://crypto-sandbox.yativo.com/api/v1/agentic-wallets/{walletId}/activation/activate"
...
<RequestExample>
```bash
curl -X POST 'https://crypto-sandbox.yativo.com/api/v1/agentic-wallets/aw_01abc123/activation/activate' \
