...
Balance values are returned as both a decimal float and an integer in minor units (cents). For example, `$145.50` → `ledger_balance: 145.50`, `ledger_balance_minor: 14550`. All fields are `null` until the account wallet is deployed.
