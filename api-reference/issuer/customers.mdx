...
<Note>
  **Card issuer customers are separate from WaaS customers.** This endpoint returns customers who have gone through card KYC onboarding and have a Gnosis Safe wallet for card spending. For wallet sub-accounts (deposits, withdrawals, crypto transfers), see [WaaS Customers](/yativo-crypto/customers).
</Note>
