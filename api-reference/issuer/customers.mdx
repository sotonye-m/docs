    ...
    "customers": [
      {
        ...
        "step": 3,
        "next_action": "Awaiting KYC approval from Gnosis Pay",
        "safe_deployed": false,
        "currency": null,
        "cards_count": 0,
...
| `kyc_initiated` | 3 | Awaiting KYC approval from Gnosis Pay |
| `kyc_completed` | 4 | Submit source-of-funds questionnaire |
| `safe_deploying` | 5 | Safe wallet is being deployed — wait a few minutes |
...
Customers with `safe_deployed: false` cannot be funded yet — the Safe wallet deploys automatically once KYC is approved.
