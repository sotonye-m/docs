...
api: "POST /v1/yativo-card/{yativoCardId}/cards/virtual"
...
<RequestExample>
```bash
curl -X POST 'https://crypto-api.yativo.com/api/v1/yativo-card/yativo_card_0xAbCd1234EfGh5678IjKl9012_1769031332068/cards/virtual' \
