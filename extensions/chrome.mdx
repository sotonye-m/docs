...
The **Auto-Forward** tab lets you view, create, and delete auto-forwarding rules without opening the full dashboard.
...
Toggle the switch next to any existing rule, or click **Delete** to remove it permanently.
