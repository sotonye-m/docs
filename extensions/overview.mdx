...
<CardGroup cols={2}>
  ...
  <Card title="Firefox Extension" icon="firefox" href="/extensions/firefox">
    Install from Firefox Add-ons (AMO). Built on Manifest v3.
  </Card>
</CardGroup>
...
The extension runs a background service worker that polls the Yativo API every **30 seconds** and fires a browser notification the moment a new deposit is detected on any monitored wallet.
